...
export declare const listWorkspaces: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const getWorkspace: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
