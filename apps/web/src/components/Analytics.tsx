...
export function Analytics() {
  ...
  const chartGridStroke = isDark ? 'rgba(255, 255, 255, 0.08)' : 'rgba(0, 0, 0, 0.06)';
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="h-64 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={overview || []} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
                  <Line type="monotone" dataKey="weeklyVelocity" stroke="#3B82F6" strokeWidth={3} dot={{ r: 4 }} activeDot={{ r: 6 }} />
                  <CartesianGrid stroke={chartGridStroke} strokeDasharray="5 5" vertical={false} />
                  <XAxis dataKey="date" stroke={chartAxisStroke} tickFormatter={formatChartDate} />
          ...
          <div className="v4-card p-6 shadow-sm">
            ...
            <div className="h-64 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={overview || []} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
                  <Line type="monotone" dataKey="deepWorkLogged" stroke="#8B5CF6" strokeWidth={3} dot={{ r: 4 }} />
                  <CartesianGrid stroke={chartGridStroke} strokeDasharray="5 5" vertical={false} />
                  <XAxis dataKey="date" stroke={chartAxisStroke} tickFormatter={formatChartDate} />
                  <YAxis stroke={chartAxisStroke} />
                  <Tooltip 
