...
const MOOD_OPTIONS = [
 ...
 { label: 'Deep Focus', icon: Brain, desc: 'Sustained cognitive immersion', color: 'text-[#2563EB] ', bg: 'bg-[#2563EB]/10 border-[#2563EB]/20' },
...
const FOCUS_THEMES = [
 { id: 'sprint', label: '25m Focus Sprint', mins: 25, icon: Rocket, color: 'border-[#F59E0B]/30 hover:border-[#F59E0B] bg-[#F59E0B]/10 text-[#D97706] ', activeColor: 'bg-[#F59E0B] text-white border-[#F59E0B] ring-2 ring-[#F59E0B]/50 font-bold', badge: 'POMODORO SPRINT', desc: 'High-intensity Pomodoro sprint for rapid code execution' },
 { id: 'deep', label: '45m Deep Work', mins: 45, icon: Brain, color: 'border-[#2563EB]/30 hover:border-[#2563EB] bg-[#2563EB]/10 text-[#2563EB] ', activeColor: 'bg-[#2563EB] text-white border-[#2563EB] ring-2 ring-[#2563EB]/50 font-bold', badge: 'COGNITIVE IMMERSION', desc: 'Sustained focus for complex architecture & refactoring' },
 ...
 { id: 'stopwatch', label: 'Open Stopwatch', mins: 0, icon: Clock, color: 'border-[#2563EB]/30 hover:border-[#2563EB] bg-[#2563EB]/10 text-[#2563EB] ', activeColor: 'bg-[#2563EB] text-white border-[#2563EB] ring-2 ring-[#2563EB]/50 font-bold', badge: 'UNBOUNDED FLOW', desc: 'Count up indefinitely without time constraints' },
 { id: 'custom', label: 'Custom Timer', mins: -1, icon: Settings, color: 'border-[#7C3AED]/30 hover:border-[#7C3AED] bg-[#7C3AED]/10 text-[#7C3AED] ', activeColor: 'bg-[#7C3AED] text-white border-[#7C3AED] ring-2 ring-[#7C3AED]/50 font-bold', badge: 'CUSTOM TARGET', desc: 'Set your own custom minutes target for this session' }
];
...
export function DailyReview() {
 ...
 <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-[#F59E0B]/20 to-[#2563EB]/20 border border-[#F59E0B]/30 flex items-center justify-center mb-6 shadow-2xl">
 <Brain className="w-10 h-10 text-[#FBBF24] animate-pulse stroke-[1.5]" />
 </div>
 
 <div className="flex items-center gap-3 mb-4 font-mono">
 <span className="px-3 py-1 rounded-full bg-[#F59E0B]/20 border border-[#F59E0B]/40 text-[#FBBF24] text-caption font-bold uppercase tracking-wider">
 {activeTheme.badge}
 </span>
 <span className="text-caption uppercase tracking-[0.2em] text-muted flex items-center gap-2">
 ...
 <h1 className="text-title text-primary mb-4 sm: md: drop-shadow-2xl">
 {displayTime}
 </h1>
 
 <p className="text-caption sm:text-body text-muted mb-12 max-w-md font-mono leading-relaxed">
 ...
 <div className="w-12 h-12 rounded-2xl bg-[#F59E0B] text-white flex items-center justify-center shrink-0 shadow-sm border border-[#F59E0B]/20">
 <Sunset className="w-6 h-6 stroke-[1.5]" />
 </div>
 <div>
 <div className="flex items-center gap-2.5 mb-1">
 <h1 className="text-title text-primary mb-4 ">Daily Review & Reflection</h1>
 <span className="bg-[#F59E0B]/10 text-[#D97706] border border-[#F59E0B]/30 px-2.5 py-0.5 rounded-md text-[10px] font-mono font-bold uppercase tracking-wider flex items-center gap-1">
 ...
 <div className="w-10 h-10 rounded-xl bg-[#F59E0B]/20 text-[#D97706] flex items-center justify-center shrink-0 border border-[#F59E0B]/30">
 ...
 <Brain className="w-5 h-5 text-[#D97706] stroke-[1.5]" />
 </div>
 <div>
 <div className="flex items-center gap-2 mb-0.5">
 <h2 className="text-section text-primary mb-3 ">Theme-Based Focus Timer</h2>
 <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded bg-[#F59E0B]/10 text-[#D97706] border border-[#F59E0B]/30 uppercase">
 {activeTheme.badge}
 </span>
 </div>
 ...
 <div className="bg-[#F59E0B]/15 border border-[#F59E0B]/30 px-3.5 py-2 rounded-xl flex items-center gap-2 text-[#D97706] text-caption font-mono font-bold shadow-2xs">
 ...
 className="px-3.5 py-1.5 bg-[#F59E0B]/10 hover:bg-[#F59E0B]/20 text-[#D97706] border border-[#F59E0B]/30 rounded-lg text-caption font-mono font-bold transition-colors flex items-center gap-1.5 cursor-pointer shadow-2xs"
 >
 ...
 className="w-full text-left px-2.5 py-1.5 rounded-lg text-caption text-primary hover:bg-[#F59E0B]/10 hover:text-[#D97706] :text-[#FBBF24] truncate transition-colors flex items-center gap-2 cursor-pointer font-medium"
 >
 ...
 className="w-full text-left px-2.5 py-1.5 rounded-lg text-caption text-primary hover:bg-[#109868]/10 hover:text-[#109868] truncate transition-colors flex items-center gap-2 cursor-pointer font-medium"
 >
 ...
 className="w-full text-left px-2.5 py-1.5 rounded-lg text-caption text-primary hover:bg-[#2563EB]/10 hover:text-[#2563EB] :text-[#2563EB] truncate transition-colors flex items-center gap-2 cursor-pointer font-medium"
 >
 <FolderKanban className="w-3 h-3 text-[#2563EB] shrink-0 stroke-[1.5]" /> {proj.name}
 </button>
 ))}
 ...
 <div className="text-caption font-mono font-bold text-secondary uppercase tracking-wider flex items-center gap-1.5">
 ...
 className="w-20 px-3 py-1.5 bg-surface border border-border rounded-lg text-body text-primary font-bold text-center focus:outline-none focus:border-[#F59E0B]"
 />
 ...
 className="w-12 h-12 rounded-full bg-[#2563EB] text-white flex items-center justify-center shadow-sm hover:bg-[#1D4ED8] transition-colors cursor-pointer shrink-0"
 >
 ...
 className="w-10 h-10 rounded-full border border-[#109868]/30 text-[#109868] flex items-center justify-center hover:bg-[#109868]/10 transition-colors cursor-pointer shrink-0"
 title="Bank Session"
 >
 ...
 <div className="text-caption font-mono uppercase tracking-widest text-[#2563EB] mb-3 flex items-center justify-center md:justify-start gap-2 font-bold">
 <Clock className="w-3.5 h-3.5 text-[#2563EB] animate-pulse stroke-[1.5]" />
 {activeTheme.label}
 </div>
 ...
 <div className="space-y-3">
 <label className="text-caption font-mono font-bold text-primary uppercase tracking-wider flex items-center gap-2">
 <Zap className="w-4 h-4 text-[#2563EB] stroke-[1.5]" /> Calibrate Energy Level
 </label>
 ...
 isSelected ?"bg-white/20 text-white" :"bg-surface-hover border border-border text-[#2563EB]"
 )}>
 {opt.label[0]}
 </div>
 <div>
 ...
 i <= opt.bars ? (isSelected ?"bg-white" :"bg-[#2563EB]") : (isSelected ?"bg-white/20" :"bg-surface-hover border border-border")
 )} 
 />
 ))}
 </div>
 ...
 <div className="w-14 h-14 rounded-2xl bg-[#F59E0B] text-white flex items-center justify-center shrink-0 shadow-md border border-[#F59E0B]/30">
