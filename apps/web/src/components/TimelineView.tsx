...
export function TimelineView() {
 ...
 <div className={cn("w-4 h-4 rounded-full ring-4 ring-white flex items-center justify-center transition-colors",
 ...
 isHabitDone ?"text-muted line-through" :"text-primary"
 )}>{habit.name}</div>
