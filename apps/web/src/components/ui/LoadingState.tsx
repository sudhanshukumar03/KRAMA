...
export function LoadingState({
 ...
 <div className="h-8 w-full bg-border rounded-lg animate-pulse" />
 ...
 <div className="h-8 w-3/4 bg-border rounded-lg animate-pulse" />
 ...
 <div className="h-full bg-border w-2/3 animate-pulse" />
 </div>
 </div>
 </div>
 ))}
 ...
 <div className="w-10 h-10 rounded-xl bg-accent/10 animate-pulse" />
 </div>
 ))}
 </div>
 ...
 {[1, 2, 3, 4, 5].map((j) => (
 <div key={j} className="flex items-center justify-between py-3 border-b border-border last:border-none">
 ...
 <div className="w-12 h-12 rounded-2xl bg-accent/10 border border-accent/20 flex items-center justify-center shadow-sm">
 <Loader2 className="w-6 h-6 text-accent animate-spin stroke-[2]" />
 </div>
 <div className="absolute -inset-1 rounded-2xl bg-accent/15 blur-md -z-10 animate-pulse" />
 </div>
 <h3 className="text-sm text-primary font-semibold mb-1">{title}</h3>
