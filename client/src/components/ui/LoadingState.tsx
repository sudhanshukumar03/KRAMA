...
export function LoadingState({
      ...
      <div className="p-6 space-y-6 w-full animate-in fade-in duration-200">
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            <div className="h-6 w-48 bg-[#F3F4F6] rounded-md animate-pulse" />
            <div className="h-4 w-72 bg-[#F8F9FB] rounded-md animate-pulse" />
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="p-5 bg-white border border-[#E5E8EC] rounded-xl space-y-3 shadow-2xs">
              <div className="flex justify-between items-center">
                <div className="h-4 w-24 bg-[#F3F4F6] rounded animate-pulse" />
                <div className="w-8 h-8 rounded-lg bg-[#F8F9FB] animate-pulse" />
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 p-6 bg-white border border-[#E5E8EC] rounded-xl space-y-4 shadow-2xs h-80">
            <div className="h-5 w-40 bg-[#F3F4F6] rounded animate-pulse" />
            <div className="space-y-3 pt-2">
              {[1, 2, 3, 4].map((j) => (
                <div key={j} className="h-12 bg-[#F8F9FB] rounded-lg animate-pulse" />
              ))}
            </div>
          </div>
          <div className="p-6 bg-white border border-[#E5E8EC] rounded-xl space-y-4 shadow-2xs h-80">
            <div className="h-5 w-32 bg-[#F3F4F6] rounded animate-pulse" />
            <div className="space-y-3 pt-2">
              {[1, 2, 3].map((k) => (
                <div key={k} className="h-14 bg-[#F8F9FB] rounded-lg animate-pulse" />
              ))}
            </div>
          </div>
        </div>
  ...
  if (variant === 'kanban') {
    return (
      <div className="p-6 space-y-6 w-full h-full flex flex-col animate-in fade-in duration-200">
        <div className="flex items-center justify-between">
          <div className="h-6 w-36 bg-[#F3F4F6] rounded-md animate-pulse" />
          <div className="flex gap-2">
            <div className="h-9 w-24 bg-[#F8F9FB] border border-[#E5E8EC] rounded-lg animate-pulse" />
            <div className="h-9 w-28 bg-[#2563EB]/20 rounded-lg animate-pulse" />
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 flex-1">
          {['Backlog', 'To Do', 'In Progress', 'Done'].map((col, i) => (
            <div key={col} className="bg-[#F8F9FB] border border-[#E5E8EC] rounded-xl p-4 space-y-3 flex flex-col">
              <div className="flex justify-between items-center pb-2 border-b border-[#E5E8EC]">
              ...
              <div className="space-y-3 flex-1">
                {Array.from({ length: 3 - (i % 2) }).map((_, j) => (
                  <div key={j} className="p-4 bg-white border border-[#E5E8EC] rounded-lg space-y-2.5 shadow-2xs">
                    <div className="flex justify-between">
                      <div className="h-3 w-12 bg-[#F3F4F6] rounded animate-pulse" />
                      <div className="w-4 h-4 rounded bg-[#F3F4F6] animate-pulse" />
                    </div>
                    <div className="h-4 w-full bg-[#E5E8EC] rounded animate-pulse" />
                    <div className="h-4 w-2/3 bg-[#F3F4F6] rounded animate-pulse" />
                    <div className="flex justify-between pt-2">
                      <div className="h-5 w-16 bg-[#F8F9FB] rounded animate-pulse" />
  ...
  if (variant === 'brain') {
    return (
      <div className="flex h-full w-full animate-in fade-in duration-200">
        <div className="w-64 border-r border-[#E5E8EC] bg-[#F8F9FB] p-4 space-y-4 hidden md:block">
          <div className="h-8 w-full bg-[#E5E8EC] rounded-lg animate-pulse" />
          <div className="space-y-2 pt-2">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="h-7 bg-white border border-[#E5E8EC] rounded-md animate-pulse" />
            ))}
          </div>
        </div>
        <div className="flex-1 p-8 space-y-6 max-w-4xl mx-auto">
          <div className="space-y-3 pb-6 border-b border-[#E5E8EC]">
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="h-4 w-4/5 bg-[#F8F9FB] rounded animate-pulse" />
            <div className="h-32 w-full bg-[#F8F9FB] border border-[#E5E8EC] rounded-xl animate-pulse my-6" />
            <div className="h-4 w-full bg-[#F3F4F6] rounded animate-pulse" />
            <div className="h-4 w-2/3 bg-[#F3F4F6] rounded animate-pulse" />
          </div>
        </div>
  ...
  if (variant === 'goals') {
    return (
      <div className="p-6 space-y-6 w-full animate-in fade-in duration-200">
        <div className="flex justify-between items-center">
          <div className="h-6 w-40 bg-[#F3F4F6] rounded-md animate-pulse" />
          <div className="h-9 w-32 bg-[#2563EB]/20 rounded-lg animate-pulse" />
        </div>
        <div className="space-y-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="p-5 bg-white border border-[#E5E8EC] rounded-xl space-y-4 shadow-2xs">
              <div className="flex justify-between items-start">
                <div className="space-y-2 flex-1">
                  <div className="flex items-center gap-2">
                    <div className="w-5 h-5 rounded bg-[#F3F4F6] animate-pulse" />
                    <div className="h-5 w-64 bg-[#E5E8EC] rounded animate-pulse" />
                    <div className="h-5 w-16 bg-[#F8F9FB] rounded-full animate-pulse" />
                  </div>
                  <div className="h-3 w-96 bg-[#F8F9FB] rounded animate-pulse" />
                </div>
                <div className="w-12 h-6 bg-[#F3F4F6] rounded animate-pulse" />
              </div>
              <div className="space-y-1.5 pt-2 border-t border-[#F3F4F6]">
                <div className="flex justify-between text-xs">
                  <div className="h-3 w-24 bg-[#F3F4F6] rounded animate-pulse" />
                  <div className="h-3 w-10 bg-[#F3F4F6] rounded animate-pulse" />
                </div>
                <div className="h-2 w-full bg-[#F8F9FB] rounded-full overflow-hidden">
  ...
  if (variant === 'habit-tracker') {
    return (
      <div className="p-6 space-y-6 w-full animate-in fade-in duration-200">
        <div className="flex justify-between items-center">
          <div className="h-6 w-44 bg-[#F3F4F6] rounded-md animate-pulse" />
          <div className="h-9 w-32 bg-[#0D9488]/20 rounded-lg animate-pulse" />
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[1, 2, 3].map((i) => (
            <div key={i} className="p-4 bg-white border border-[#E5E8EC] rounded-xl flex items-center justify-between shadow-2xs">
        ...
        <div className="bg-white border border-[#E5E8EC] rounded-xl p-5 space-y-4 shadow-2xs">
          <div className="h-5 w-36 bg-[#F3F4F6] rounded animate-pulse mb-4" />
          {[1, 2, 3, 4, 5].map((j) => (
            <div key={j} className="flex items-center justify-between py-3 border-b border-[#F8F9FB] last:border-none">
              ...
              <div className="flex gap-2">
                {[1, 2, 3, 4, 5, 6, 7].map((k) => (
                  <div key={k} className="w-8 h-8 rounded-lg bg-[#F8F9FB] border border-[#E5E8EC] animate-pulse" />
                ))}
              </div>
            </div>
          ))}
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] w-full p-8 animate-in fade-in duration-200">
      ...
      <p className="text-xs text-[#6B7280] max-w-sm text-center">{description}</p>
